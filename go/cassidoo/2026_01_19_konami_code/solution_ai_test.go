...
func TestKonamiCodeAI(t *testing.T) {
	t.Run("should work with example 1", func(t *testing.T) {
		result, err := KonamiCodeAI("xx2233454590yy11110")
	...
	t.Run("should work with example 2", func(t *testing.T) {
		result, err := KonamiCodeAI("sduwahoda22ii0d0dbn")
	...
	t.Run("should return err if no mapping found", func(t *testing.T) {
		_, err := KonamiCodeAI("abcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabc")
